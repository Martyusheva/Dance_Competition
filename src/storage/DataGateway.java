...
public class DataGateway {
    ...
    private static final String URL = "jdbc:mysql://localhost/dancecompdb";
    ...
    public void dropAll() throws SQLException {
        executeSqlScript(getDataSource().getConnection(), new File("/home/moresmart/IdeaProjects/dance_competition_v1/db/db_create.sql"));
    }
